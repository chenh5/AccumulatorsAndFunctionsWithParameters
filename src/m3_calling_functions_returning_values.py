...
def test_sum_of_digits():
    ...
    # ------------------------------------------------------------------
    expected1 = 11
    answer1 = sum_of_digits(515)
    print('Test 3 expected:', expected1)
    print('       actual:  ', answer1)

    expected2 = 15
    answer2 = sum_of_digits(807)
    print('Test 4 expected:', expected2)
    print('       actual:  ', answer2)

    expected3 = 27
    answer3 = sum_of_digits(999)
    print('Test 5 expected:', expected3)
